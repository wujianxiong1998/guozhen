...
//分页
export async function getProductionManageFillList(param) {
...
//删除
export async function deleteProductionManageFill(param) {
    return request('/cloud/gzzhsw/api/cp/data/fill/delete.smvc', {
        method: 'post',
        body: param,
    })
}
...
//修改
export async function saveProductionManageFill(param) {
...
//获取填报数据初始数据
export async function getDefaultProductionManageFill(param) {
...
//获取详情
export async function getProductionManageFillDetail(param) {
...
//审核
export async function auditProductionManageFill(params) {
...
//验重
export async function ifExistProductionManageFill(params) {
