...
import { Table,Icon,Popconfirm,Tooltip,Checkbox,Popover } from 'antd';
import styles from './VortexDatagrid.less';
...
class VortexDatagrid extends React.Component{ 
            ...
            if(col.nowrap){
                ...
                if(typeof(newCol.render)=='function'){
                    ...
                    newCol.render = function(text, record){
                        ...
                        return <Tooltip title={text} placement="topLeft">{oldRender(text, record)}</Tooltip>
                    }
                }
                else{
                    newCol.render = function(text, record){
    ...
    getNewProps(){
        ...
        let newProps = {
            ...t.props,
            columns: t.state.columnConfig.filter((item)=>{
