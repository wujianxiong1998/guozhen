...
function View(props) {
    ...
    const {
        ...
        processSize, waterStandard, minWaterFlow, waterPrice, regionalCompanyName, businessUnitName, feeWaterFlow, putIntoOperationDate
    } = contentProps;
        ...
        >
            <div className={styles.viewModalContainer}>
                <VtxModalList>
                    ...
                    <div
                        data-modallist={{
                            layout: {type: 'text', name: '收费水量', width: 100, key: 'feeWaterFlow'}
                        }}
                    >{feeWaterFlow+'万吨/日'}</div>
                    <div
                        data-modallist={{
                    ...
                    <div
                        data-modallist={{
                            layout: {type: 'text', name: '投运时间', width: 100, key: 'putIntoOperationDate'}
                        }}
                    >{putIntoOperationDate}</div>
                </VtxModalList>
            </div>
        </VtxModal>
    )
