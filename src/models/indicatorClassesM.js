...
export default {
    ...
    namespace : 'indicatorClasses', // 指标类别
    ...
    effects : {
        ...
        *getList({ payload = {} }, { call, put, select }) {
            ...
            } = yield select(({indicatorClasses}) => indicatorClasses);
        ...
        *saveOrUpdate({ payload }, { call, put, select }) {
            ...
            const { newItem, editItem } = yield select( ({indicatorClasses}) => indicatorClasses );
            const {
                id, name, code
