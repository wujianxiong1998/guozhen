...
export default {
    ...
    namespace: 'productionFill', // 生产数据填报
    ...
    effects: {
        ...
        *getList({ payload = {} }, { call, put, select }) {
            ...
            let {
                queryParams
            } = yield select(({ productionFill }) => productionFill);
            let params = {
                ...queryParams,
        ...
        *saveOrUpdate({ payload = {} }, { call, put, select }) {
            ...
            const { queryParams,id, dataSource }=yield select(({ productionFill }) => productionFill);
        ...
        *calculateTargetValue({ payload = {} }, { call, put, select }) {
            const { dataSource } = yield select(({ productionFill }) => productionFill);
