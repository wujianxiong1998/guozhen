...
export default {
    ...
    effects: {
        ...
        *getList({ payload = {} }, { call, put, select }) {
            ...
            } = yield select(({deviceUpdateLog}) => deviceUpdateLog);
           ...
           pageSize = 'pageSize' in payload ? payload.pageSize : pageSize;
            ...
            const { data } = yield call(deviceUpdateService.getList, params);
        ...
        *getD({ payload }, { call, put, select }) {
            ...
            const { data } = yield call(deviceUpdateService.detail, params);
            if(!!data && !data.result){
                yield put({
                    type: 'updateState',
                    payload: {
