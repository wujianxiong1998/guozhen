...
export default {
    ...
    namespace: 'abnormalTypeBig', // 异常大类
    ...
    effects: {
        ...
        *getList({ payload = {} }, { call, put, select }) {
            ...
            } = yield select(({ abnormalTypeBig }) => abnormalTypeBig);
        ...
        *saveOrUpdate({ payload }, { call, put, select }) {
            ...
            const { newItem, editItem } = yield select(({ abnormalTypeBig }) => abnormalTypeBig);
            const {
                id, name, code,
