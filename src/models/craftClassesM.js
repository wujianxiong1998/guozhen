...
export default {
    ...
    effects : {
        ...
        *getList({ payload = {} }, { call, put, select }) {
            ...
            } = yield select(({craftClasses}) => craftClasses);
        ...
        *saveOrUpdate({ payload }, { call, put, select }) {
            ...
            const { newItem, editItem } = yield select( ({craftClasses}) => craftClasses );
            const {
                id, name,code,
