import { getRegionalCompanyList, addRegionalCompany, updateRegionalCompany, commonDelete, loadBusinessUnitSelect } from '../services/remoteData';
...
export default {
    ...
    namespace : 'regionalCompany', // 区域公司
    ...
    effects : {
        ...
        *getList({ payload = {} }, { call, put, select }) {
            ...
            } = yield select(({regionalCompany}) => regionalCompany);
            ...
            const { data } = yield call(getRegionalCompanyList, VtxUtil.submitTrim(params));
        ...
        *saveOrUpdate({ payload }, { call, put, select }) {
            ...
            const { newItem, editItem } = yield select( ({regionalCompany}) => regionalCompany );
            const {
            ...
            const { data } = yield call( payload.btnType === 'add' ? 
                    addRegionalCompany : updateRegionalCompany, VtxUtil.submitTrim(params));
