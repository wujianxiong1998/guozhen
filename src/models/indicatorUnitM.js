...
export default {
    ...
    effects : {
        ...
        *getList({ payload = {} }, { call, put, select }) {
            ...
            } = yield select(({indicatorUnit}) => indicatorUnit);
        ...
        *saveOrUpdate({ payload }, { call, put, select }) {
            ...
            const { newItem, editItem } = yield select( ({indicatorUnit}) => indicatorUnit );
            const {
                id, name, code
