...
export default {
    ...
    namespace : 'indicatorClassesSmall', // 指标小类
    ...
    subscriptions: {
        setup({ dispatch, history }) {
            return history.listen(({ pathname, search }) => {
                if(pathname === '/indicatorClassesSmall') {
					// 初始化state
                    dispatch({
                        type : 'updateState',
                        payload : {
    ...
    effects : {
        ...
        *getList({ payload = {} }, { call, put, select }) {
            ...
            } = yield select(({indicatorClassesSmall}) => indicatorClassesSmall);
        ...
        *saveOrUpdate({ payload }, { call, put, select }) {
            ...
            const { newItem, editItem } = yield select( ({indicatorClassesSmall}) => indicatorClassesSmall );
            const {
                id, name, code
