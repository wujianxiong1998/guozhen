import { getDataReportFinishList } from '../services/produtionService';
...
let initQueryParams = {
    waterFactoryId : '', // 水厂名称
    startTime: moment().format('YYYY-MM'), // 时间
    endTime: moment().format('YYYY-MM'), // 时间
};
...
export default {
    ...
    namespace : 'dataReportFinish', // 数据上报是审核完成率
    ...
    effects : {
        ...
        *getList({ payload = {} }, { call, put, select }) {
            ...
            } = yield select(({dataReportFinish}) => dataReportFinish);
            ...
            const { data } = yield call(getDataReportFinishList, VtxUtil.submitTrim(params));
