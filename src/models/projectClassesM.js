...
export default {
    ...
    effects : {
        ...
        *getList({ payload = {} }, { call, put, select }) {
            ...
            } = yield select(({projectClasses}) => projectClasses);
        ...
        *saveOrUpdate({ payload }, { call, put, select }) {
            ...
            const { newItem, editItem } = yield select( ({projectClasses}) => projectClasses );
            const {
                id, name, code
