...
function ProjectClasses({ dispatch, projectClasses, accessControlM }) {
    const {
        searchParams,
    ...
    const updateState = (obj) => {
        dispatch({
            type: 'projectClasses/updateState',
            payload: {
                ...obj
            }
        })
    ...
    // 更新表格数据
    const getList = () => {
        dispatch({ type: 'projectClasses/updateQueryParams' });
        dispatch({ type: 'projectClasses/getList' });
    }
    ...
    const vtxGridParams = {
        ...
        clear() {
            dispatch({ type: 'projectClasses/initQueryParams' });
            dispatch({ type: 'projectClasses/getList' });
        }
    };
    ...
    const updateNewWindow = (status = true) => {
        ...
        if (!status) {
            dispatch({ type: 'projectClasses/initNewItem' });
        }
    }
    const newItemProps = {
        ...
        contentProps: {
            ...
            save() {
                dispatch({
                    type: 'projectClasses/saveOrUpdate', payload: {
                        btnType: 'add',
                        onSuccess: function () {
...
export default connect(
    ({ projectClasses, accessControlM }) => ({ projectClasses, accessControlM })
)(ProjectClasses);