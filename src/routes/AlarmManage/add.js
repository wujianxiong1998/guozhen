        ...
        return (
            <VtxModal {...modalProps}>
                <VtxModalList {...modallistProps} ref={(lis) => this.lis1 = lis}>
                    ...
                    <Input 
                        data-modallist={{
                            layout: {width: 50,name: '报警时长',require: false},
                            regexp: {
                                value: name,
                            }
                        }}
                    ...
                    <Input 
                        data-modallist={{
                            layout: {width: 50,name: '报警次数',require: false},
                            regexp: {
                                value: name,
                            }
                        }}
                ...
                <div style={{paddingBottom: '10px', paddingLeft: '10px', fontSize: '15px', color: '#000'}}>配置报警推送规则</div>
                <VtxModalList {...modallistProps} ref={(lis) => this.lis2 = lis}>
                    <Input 
                        data-modallist={{
                            layout: {width: 50,name: '报警时长',require: false},
                            regexp: {
