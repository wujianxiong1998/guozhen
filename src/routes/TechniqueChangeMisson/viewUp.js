...
class ViewUpItem extends React.Component {
    constructor(props){
        super(props);
        this.lis1 = null;
    }
    ...
    render() {
        ...
        let { 
            ...
            actMoney, picIds, actStartDay, actEndDay, actManName, details, sparePart, countTotal,
         } = getData;
        let { afterPicIds, updateItem, access, modelLonding } = contentProps;
        let modalProps = {
            title: title,
            visible: visible,
            footer: <div>
        ...
        let uploadProps1 = (name,fieldCode,photoIds,require = true)=>{
            return {
                action:"/cloudFile/common/uploadFile",
                downLoadURL:'/cloudFile/common/downloadFile?id=',
                "data-modallist":{
            ...
            <VtxModal {...modalProps}>
                <Collapse bordered={false} defaultActiveKey={['1', '2', '3']}>
                    ...
                    <Panel header="配件详情" key="2">
                        <Table {...contentTableProps} style={{width: '100%'}}/>
                    ...
                    <Panel header="后评估" key="3">
                        <VtxModalList {...modallistProps} ref={(lis) => this.lis1 = lis}>
                            <div></div>
                            <VtxUpload2
                                {...uploadProps1('附件','afterPicIds', afterPicIds)}
                            />
                        </VtxModalList> 
                    </Panel>
                </Collapse>
