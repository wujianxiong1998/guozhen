...
class AddItem extends React.Component {
    ...
    render() {
        ...
        let { id, structuresId, newStructuresId, structuresName, deviceId, name, code, deviceStatus, newDeviceStatus, auditPeopleId, auditPeopleName, dropReason,
        ...
        return (
            <VtxModal {...modalProps}>
                ...
                <VtxCombogrid 
                    ...
                    <Input.TextArea
                        data-modallist={{
                            layout: {width: 100,name: '报废说明',require: true},
                            regexp: {
                                value: dropReason
                            }
                        }}
                        value={dropReason}
                        onChange={e=>updateItem({dropReason:e.target.value})}
                    />
                    <TreeSelect 
                        data-modallist={{
