...
function ProductionConsumeMultiple({ dispatch, productionConsumeMultiple, accessControlM, location }) {
    ...
    const updateState = (obj) => {
        dispatch({
            type: 'productionConsumeMultiple/updateState',
            payload: {
                ...obj
            }
        })
    ...
    // 更新表格数据
    const getList = () => {
        dispatch({ type: 'productionConsumeMultiple/updateQueryParams' });
        dispatch({ type: 'productionConsumeMultiple/getList' });
    }
    ...
    const vtxGridParams = {
        ...
        clear() {
            dispatch({ type: 'productionConsumeMultiple/initQueryParams' });
            dispatch({ type: 'productionConsumeMultiple/getList' });
        }
    };
    ...
    let vtxDatagridProps = {
        ...
        onChange(pagination, filters, sorter) {
            dispatch({
                type: 'productionConsumeMultiple/getList',
                payload: {
...
export default connect(
    ({ productionConsumeMultiple, accessControlM }) => ({ productionConsumeMultiple, accessControlM })
)(ProductionConsumeMultiple);