...
function AssayDataMultiple({ dispatch, assayDataMultiple, accessControlM, location }) {
    ...
    const updateState = (obj) => {
        dispatch({
            type: 'assayDataMultiple/updateState',
            payload: {
                ...obj
            }
        })
    ...
    // 更新表格数据
    const getList = () => {
        dispatch({ type: 'assayDataMultiple/updateQueryParams' });
        dispatch({ type: 'assayDataMultiple/getList' });
    }
    ...
    const vtxGridParams = {
        ...
        clear() {
            dispatch({ type: 'assayDataMultiple/initQueryParams' });
            dispatch({ type: 'assayDataMultiple/getList' });
        }
    };
    ...
    let vtxDatagridProps = {
        ...
        onChange(pagination, filters, sorter) {
            dispatch({
                type: 'assayDataMultiple/getList',
                payload: {
...
export default connect(
    ({ assayDataMultiple, accessControlM }) => ({ assayDataMultiple, accessControlM })
)(AssayDataMultiple);