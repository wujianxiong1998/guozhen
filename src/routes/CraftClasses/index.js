...
function CraftClasses({ dispatch, craftClasses,accessControlM }) {
    const {
        searchParams,
    ...
    // 更新表格数据
    const getList = () => {
        dispatch({ type: 'craftClasses/updateQueryParams' });
        dispatch({ type: 'craftClasses/getList' });
    }
    ...
    const vtxGridParams = {
        ...
        clear() {
            dispatch({ type: 'craftClasses/initQueryParams' });
            dispatch({ type: 'craftClasses/getList' });
        }
    };
    ...
    const updateNewWindow = (status = true) => {
        ...
        if (!status) {
            dispatch({ type: 'craftClasses/initNewItem' });
        }
    }
    const newItemProps = {
        ...
        contentProps: {
            ...
            save() {
                dispatch({
                    type: 'craftClasses/saveOrUpdate', payload: {
                        btnType: 'add',
                        onSuccess: function () {
...
export default connect(
    ({ craftClasses, accessControlM }) => ({ craftClasses, accessControlM })
)(CraftClasses);