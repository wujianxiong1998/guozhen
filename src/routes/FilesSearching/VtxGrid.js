            ...
            <div className={`${styles.normal} ${t.props.className}`} style={{height: `${t.state.height}px`,...t.state.style}}>
                <VtxRow gutter={10}  attr='row'>
                    ...
                    <VtxCol span={ar} xl={{span:3}}>
                        <VtxRow gutter={20}  attr='row'>
                            {
                                // t.state.hiddenconfrimButtion?"":
                                t.props.hiddenconfrimButtion?"":
                                <VtxCol span={8}>
                                    <span data-type={'bt'}>
                                        <Button type="primary" onClick={props.confirm}>{props.confirmText || '查询'}</Button>
                                    </span>
                                </VtxCol>
                            }
                            {
                                ...
                                <VtxCol span={8}>
                                    <span data-type={'bt'}>
                                        <Button onClick={props.clear}>{props.clearText || '清空'}</Button>
                                    </span>
                                </VtxCol>
                            }
                            <VtxCol span={8}>
                                <span data-type={'bt'}>
                                    <Button type="primary" onClick={props.choose}>{props.confirmText || '筛选'}</Button>
                                </span>
                            </VtxCol>
                            {/* <VtxCol span={4}>
                                {
