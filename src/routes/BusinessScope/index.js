...
function BusinessScope({ dispatch, businessScope, accessControlM }) {
    const {
        searchParams,
    ...
    const updateState = (obj) => {
        dispatch({
            type: 'businessScope/updateState',
            payload: {
                ...obj
            }
        })
    ...
    // 更新表格数据
    const getList = () => {
        dispatch({ type: 'businessScope/updateQueryParams' });
        dispatch({ type: 'businessScope/getList' });
    }
    ...
    const vtxGridParams = {
        ...
        clear() {
            dispatch({ type: 'businessScope/initQueryParams' });
            dispatch({ type: 'businessScope/getList' });
        }
    };
    ...
    const updateNewWindow = (status = true) => {
        ...
        if (!status) {
            dispatch({ type: 'businessScope/initNewItem' });
        }
    }
    const newItemProps = {
        ...
        contentProps: {
            ...
            save() {
                dispatch({
                    type: 'businessScope/saveOrUpdate', payload: {
                        btnType: 'add',
                        onSuccess: function () {
...
export default connect(
    ({ businessScope, accessControlM }) => ({ businessScope, accessControlM })
)(BusinessScope);